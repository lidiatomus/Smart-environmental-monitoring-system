...
HD_PWD='C:/LIDIA/Poli/anul3/scs/proiect_scs/proiect_scs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Packet_FSM_Decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Packet_FSM_Decoder.tcl
