...
begin
  ...
  begin
    if rising_edge(i_Clk) then
      ...
      elsif i_data_valid = '1' then -- in the final top, this signal becomes 1 when the fsm decoder finished with the decoding of the data, in the tb i manuallt drive it 1 and 0
